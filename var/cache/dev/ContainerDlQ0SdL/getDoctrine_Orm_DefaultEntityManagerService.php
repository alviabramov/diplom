...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), [0 => (\dirname(__DIR__, 4).'/src/Common/Entity')]), 'App\\Common\\Entity');

        $a->setEntityNamespaces(['App' => 'App\\Common\\Entity']);
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Common\\Repository\\ContentRepository' => ['privates', 'App\\Common\\Repository\\ContentRepository', 'getContentRepositoryService', true],
        ], [
            'App\\Common\\Repository\\ContentRepository' => '?',
        ])));
